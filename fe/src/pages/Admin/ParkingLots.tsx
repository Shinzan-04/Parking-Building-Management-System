  ...
  return (
    <div className="space-y-4">
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${occupied && isSelected
                        ? 'bg-amber-400 border-amber-400 text-[#0F1B2D] shadow-md shadow-amber-400/30 scale-105 z-10'
                        : occupied
                          ? 'bg-[#00C2FF]/15 border-[#00C2FF]/40 text-[#00C2FF]/80 hover:bg-amber-400/20 hover:border-amber-400/60 hover:text-amber-300'
                          : isSelected
                            ? 'bg-[#3BFFA4] border-[#3BFFA4] text-[#0F1B2D] shadow-md shadow-[#3BFFA4]/30 scale-105 z-10'
                            : 'bg-white/5 border-white/10 text-white/30 hover:bg-[#3BFFA4]/10 hover:border-[#3BFFA4]/50 hover:text-[#3BFFA4]'
                      }
                    `}
                  >
      ...
      <div className="flex items-center flex-wrap gap-4 pt-2 border-t border-white/5 text-xs text-white/40">
        ...
        {selectedSlotId && (
          <div className="flex items-center gap-1.5">
            <div className={`w-4 h-4 rounded border ${selectedIsOccupied ? 'bg-amber-400 border-amber-400' : 'bg-[#3BFFA4] border-[#3BFFA4]'}`} />
            Đang chọn
          </div>
        )}
          ...
          <div className="flex items-center justify-between gap-3 px-4 py-3 bg-amber-400/10 border border-amber-400/30 rounded-xl">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-400 text-[#0F1B2D] text-xs font-semibold hover:opacity-90 transition-opacity disabled:opacity-60"
              >
          ...
          <div className="flex items-center justify-between gap-3 px-4 py-3 bg-[#3BFFA4]/10 border border-[#3BFFA4]/30 rounded-xl">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#3BFFA4] text-[#0F1B2D] text-xs font-semibold hover:opacity-90 transition-opacity disabled:opacity-60"
              >
                {confirming ? <Loader2 size={12} className="animate-spin" /> : <CircleCheck size={12} />}
                Xác nhận phân bổ
              </button>
    ...
    <div className="space-y-6">
      ...
      {(modalType === 'add' || modalType === 'edit') && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="bg-[#0A1628] border border-white/10 rounded-2xl w-full max-w-lg shadow-2xl flex flex-col max-h-[90vh]">

            {/* Header */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 shrink-0">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-[#00C2FF]/10 flex items-center justify-center">
                  <Building2 size={17} className="text-[#00C2FF]" />
                </div>
                <div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-3.5 py-2.5 text-sm text-white placeholder-white/20 focus:outline-none focus:border-[#00C2FF]/50 transition-colors"
                  />
                </div>
                <div>
                  ...
                  {modalType === 'edit' && (
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-3.5 py-2.5 text-sm text-white focus:outline-none focus:border-[#00C2FF]/50 transition-colors appearance-none"
                      >
                        <option value="active"      className="bg-[#0A1628]">Hoạt động</option>
                        <option value="maintenance" className="bg-[#0A1628]">Bảo trì</option>
                        <option value="full"        className="bg-[#0A1628]">Đầy chỗ</option>
                      </select>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex justify-between text-[10px] text-white/25">
                      <span>0</span>
                      {remainingCapacity > 0
                        ? <span className="text-[#3BFFA4]/60">còn {remainingCapacity} chỗ</span>
                        ...
                        >
                          {editingFloorId === f.id ? (
                            ...
                            <div className="p-4 space-y-3">
                              <div className="flex items-center justify-between">
                                <span className="text-xs font-semibold text-[#00C2FF] flex items-center gap-1.5">
                              ...
                              <div className="grid grid-cols-2 gap-2">
                                <div>
                                  ...
                                  <input
                                    ...
                                    className="w-full bg-white/10 border border-white/20 rounded-lg px-2.5 py-2 text-xs text-white focus:outline-none focus:border-[#00C2FF]/50 transition-colors"
                              ...
                              {editFloorActualCount !== null
                                ...
                                <div>
                                  ...
                                  <select
                                    ...
                                    className="w-full bg-white/10 border border-white/20 rounded-lg px-2.5 py-2 text-xs text-white focus:outline-none focus:border-[#00C2FF]/50 transition-colors appearance-none"
                                  >
                                    <option value="" className="bg-[#0A1628]">-- Chọn loại xe --</option>
                                    {vehicleTypes.map(vt => (
                                      <option key={vt.id} value={vt.id} className="bg-[#0A1628]">{vt.name}</option>
                                    ))}
                                  </select>
                                </div>
                              )}
                              ...
                              <div className="flex gap-2">
                                <button
                                  ...
                                  className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg bg-[#3BFFA4]/12 border border-[#3BFFA4]/20 text-[#3BFFA4] text-xs font-semibold hover:bg-[#3BFFA4]/20 transition-all disabled:opacity-40"
                                >
                            ...
                            <div className="flex items-center justify-between px-3.5 py-3">
                              ...
                              <div className="flex items-center gap-0.5">
                                <button
                                  ...
                                  disabled={floorLoading}
                                  className="p-2 rounded-lg text-white/25 hover:text-[#00C2FF] hover:bg-[#00C2FF]/8 transition-all disabled:opacity-30"
                                  title="Chỉnh sửa"
                                >
                                  <Pencil size={13} />
                                </button>
                    ...
                    <div className="rounded-xl border border-dashed border-white/20 p-3.5 space-y-2.5">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <input
                          ...
                          className="bg-white/5 border border-white/10 rounded-lg px-2.5 py-2 text-xs text-white placeholder-white/20 focus:outline-none focus:border-[#00C2FF]/40 transition-colors"
                        />
                        <input
                          type="number"
                      ...
                      <div className="flex gap-2">
                        <select
                          ...
                          className="flex-1 bg-white/5 border border-white/10 rounded-lg px-2.5 py-2 text-xs text-white focus:outline-none focus:border-[#00C2FF]/40 transition-colors appearance-none"
                        >
                          <option value="" className="bg-[#0A1628]">-- Chọn loại xe --</option>
                          {vehicleTypes.map(vt => (
                            <option key={vt.id} value={vt.id} className="bg-[#0A1628]">{vt.name}</option>
                        ...
                        <button
                          ...
                          className="px-4 py-2 rounded-lg bg-[#00C2FF]/12 border border-[#00C2FF]/20 text-[#00C2FF] text-xs font-semibold hover:bg-[#00C2FF]/20 transition-all disabled:opacity-40 flex items-center gap-1.5 whitespace-nowrap"
                        >
            ...
            <div className="flex gap-3 px-6 py-4 border-t border-white/10 shrink-0">
              ...
              <button
                ...
                className="flex-1 py-2.5 rounded-xl text-sm font-semibold text-[#0A1628] bg-gradient-to-r from-[#00C2FF] to-[#3BFFA4] hover:opacity-90 transition-opacity disabled:opacity-55 flex items-center justify-center gap-2"
              >
