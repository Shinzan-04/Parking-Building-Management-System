...
export default function FindParkingPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-5rem)] bg-[#F3F3F5] text-stone-900 overflow-hidden font-sans antialiased selection:bg-[#FF4C4C]/25 selection:text-[#FF4C4C]">
      {/* ===== Filter Bar ===== */}
