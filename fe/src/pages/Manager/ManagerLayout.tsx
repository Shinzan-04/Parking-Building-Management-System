      ...
      <aside className="fixed top-0 left-0 h-screen w-64 bg-[#0B1120] border-r border-white/10 flex flex-col z-30">
        ...
        <div className="px-6 py-5 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#3BFFA4] to-[#00C2FF] flex items-center justify-center">
            ...
            >
              {({ isActive }) => (
                <>
                  <Icon size={17} />
                  {label}
                  {isActive && <span className="ml-auto w-1.5 h-1.5 rounded-full bg-[#3BFFA4]" />}
                </>
              )}
            </NavLink>
          ))}
        ...
        <div className="px-3 py-4 border-t border-white/10 space-y-1">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-white/5">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#3BFFA4] to-[#00C2FF] flex items-center justify-center text-[#101A31] font-bold text-sm shrink-0">
              {initials}
            </div>
        ...
        <header className="sticky top-0 z-20 bg-[#101A31]/80 backdrop-blur-md border-b border-white/10 px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button className="relative p-2 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
              ...
              <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-[#3BFFA4] rounded-full ring-2 ring-[#101A31]" />
            </button>
            <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 cursor-pointer hover:bg-white/10 transition-colors">
              <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#3BFFA4] to-[#00C2FF] flex items-center justify-center text-[#101A31] font-bold text-xs">
                {initials}
              </div>
