...
public interface ICheckOutService
{
    ...
    /// </summary>
    Task<CheckOutSearchResult> SearchByQrCodeAndPlateAsync(string? qrCode, string licensePlate, Guid? staffId = null, Guid? requestBuildingId = null, bool isLostTicket = false);
